...
const disclaimerSections = [
  ...
  },
  {
    ...
    paragraphs: [
      "Если Вы направляете Verdi & Co. персональные данные, документы, сведения о третьих лицах, контрагентах, клиентах, представителях, собственниках, бенефициарах, участниках сделки или иных лицах, Вы подтверждаете, что имеете правовое основание и необходимые полномочия для такой передачи.",
      "Продолжая переписку, направляя документы или предоставляя сведения, Вы подтверждаете, что ознакомлены с настоящим уведомлением и понимаете, что Verdi & Co. может обрабатывать полученную в переписке информацию и персональные данные для целей соответствующей деловой, договорной, претензионной, судебной, консультационной или иной профессиональной коммуникации.",
    ],
  },
];
